...
//				}
		...
		if (!textures[i]) {
		    textures[i] = LoadTexture("white.png");//new Texture(GL_TEXTURE_2D, "../../../Content/white.png");// LoadTexture("../../../Content/white.png"); //new Texture(GL_TEXTURE_2D, "../Content/white.png");
            Ret = (bool)textures[i];//textures[i]->Load();
		}
	}
